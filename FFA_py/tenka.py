...
def main():
    ...
    if mode == "battle":
        ...
        if win == 1:
            ...
            if next_winner == 0:
                # 制覇達成
                comment += f"<br><font color='{config.Config['color_yellow']}'>🏆 見事に天下一武道会で優勝したクポ！おめでとうクポ！</font>"
            ...
            comment += f"<br><font color='{config.Config['color_red']}'>敗北しましたクポ・・・お金が半分になってしまいました。</font>"
