...
def main():
    ...
    if mode == "log_in":
        ...
        comment = ""
        if win == 1:
            comment = f'<font color="{config.Config['color_green']}" size=5>{aite_chara["name"]} に勝利しました！</font><br>(練習戦のためステータスやゴールドの変動はありません)'
        elif win == 0:
            comment = f'<font color="{config.Config['color_red']}" size=5>{aite_chara["name"]} に敗北しました・・・</font><br>(練習戦のためステータスやゴールドの変動はありません)'
        else:
            comment = f'<font color="{config.Config['color_yellow']}" size=5>引き分けです。</font><br>(練習戦のためステータスやゴールドの変動はありません)'
