...
sub html_top {
	...
	print <<"EOM";
<hr size=0>
<font color=$white>メニュー/</font><a href="$scripta?mode=ranking&first=1&end=20">登録者一覧</a>
 / <a href="$scripta?mode=mori_ranking&first=1&end=20">レジェンドプレイス攻略者一覧</a>
 / <a href="$ranking">\能\力別ランキングへ</a> / <a href="$syoku_html">各職業に必要な特性値</a>
 / <a href="$scripta?mode=img_list"  target="_blank">$vote_gazou</a>
 / <a href="https://oktaviacgi-games.com/" target="_blank">おくたのCGIげーむす</a>
<br>
<hr size=0>
EOM
