...
| アイテム倉庫 | `souko` | souko.html | weapon/armor/accessory × equip/remove/delete | 🟡 本人 |
...
| ページ / コマンド | module | 主なテンプレート | body mode | 認可 |
|---|---|---|---|---|
| 掲示板(BBS) | `bbs` | `ffadventure.html`内の掲示板 | `post` → 街へredirect(PRG) | 🟡 本人 |
